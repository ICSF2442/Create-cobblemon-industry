...
public class CreateCobblemonIndustry{
    ...
    public CreateCobblemonIndustry(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (CreateCobblemonIndustry) to respond directly to events.
